  ...
  return (
    <nav className="sticky top-0 z-50 bg-surface/70 backdrop-blur-xl border-b border-outline-variant/10 px-6 py-4 flex items-center justify-between">
      ...
      >
        ...
        <span className="font-headline font-bold text-2xl text-primary tracking-tighter">ArtKids</span>
      </div>
        ...
        {isAuthenticated ? (
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64 p-2 rounded-2xl border-outline-variant/10 shadow-2xl bg-white">
                ...
                <div className="p-1 space-y-1">
                  <DropdownMenuItem className="rounded-lg h-10 px-3 cursor-pointer group" onClick={() => onNavigate("/profile")}>
                  ...
                  <DropdownMenuItem className="rounded-lg h-10 px-3 cursor-pointer group" onClick={() => onNavigate("/my-courses")}>
                  ...
                  <DropdownMenuItem className="rounded-lg h-10 px-3 cursor-pointer group" onClick={() => onNavigate("/wishlist")}>
                    <Heart className="mr-2 h-4 w-4 text-on-surface-variant group-hover:text-error" />
                    <span className="text-sm font-bold">Yêu thích ({wishlistCount})</span>
                  </DropdownMenuItem>
                  
                  {["admin", "staff", "instructor"].includes(user?.role) && (
                    <DropdownMenuItem className="rounded-lg h-10 px-3 cursor-pointer group text-primary" onClick={() => onNavigate("/dashboard")}>
